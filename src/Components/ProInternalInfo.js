                    ...
                    <div className="card-body">
                        ...
                        >
                            ...
                            <div className=" m-0 mt-3" style={{ width: "fit-content" }}>
                                ...
                                <select name='p_pantry' onChange={getPropertyDetails} className="form-select form-select-lg mb-3" aria-label=".form-select-lg example">
                                    <option disabled selected>Pantry</option>
                                    <option value="1">1</option>
                                    <option value="2">2</option>
                                </select>
                                <select name='p_cabins' onChange={getPropertyDetails} className="form-select form-select-lg mb-3" aria-label=".form-select-lg example">
                                    <option disabled selected>Cabins</option>
                                    <option value="1">1</option>
                                    <option value="2">2</option>
                                </select>
                                <select name='p_workStation' onChange={getPropertyDetails} className="form-select form-select-lg mb-3" aria-label=".form-select-lg example">
                                    <option disabled selected>Wrokstations</option>
                                    <option value="1">1</option>
                                    <option value="2">2</option>
                                </select>
                                <select name='p_conference' onChange={getPropertyDetails} className="form-select form-select-lg mb-3" aria-label=".form-select-lg example">
                    ...
                    <div className="card-body">
                        ...
                        >
                            ...
                            <div className=" m-0 mt-3" style={{ width: "fit-content" }}>
                                ...
                                <select name='p_pantry' className="form-select form-select-lg mb-3" aria-label=".form-select-lg example">
                                    <option disabled selected>Pantry</option>
                                    <option value="1">1</option>
                                    <option value="2">2</option>
                                </select>
                                <select name='p_totalFloors' className="form-select form-select-lg mb-3" aria-label=".form-select-lg example">
                                    <option disabled selected>Total Floors</option>
                                    <option value="1">1</option>
                                    <option value="2">2</option>
                                </select>
                                <select name='p_amenities' className="form-select form-select-lg mb-3" aria-label=".form-select-lg example">
                                    <option disabled selected>Amenities</option>
                                    <option value="1">1</option>
                                    <option value="2">2</option>
                                </select>
                                <select name='p_maintainanceFees' className="form-select form-select-lg mb-3" aria-label=".form-select-lg example">
                                    <option disabled selected>Maintainance Fee</option>
                                    <option value="yes">Yes</option>
                                    <option value="no">No</option>
                                </select>
